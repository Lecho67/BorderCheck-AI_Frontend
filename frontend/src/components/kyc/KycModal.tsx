...
const CONTENIDO: Record<TipoModal, { titulo: string; cuerpo: string[] }> = {
  terminos: {
    ...
    cuerpo: [
      "1. Objeto. BorderCheck AI presta servicios de casillero virtual, evaluación preliminar de envíos internacionales y acompañamiento en trámites aduaneros. Las evaluaciones generadas por IA son orientativas y no reemplazan una resolución aduanera oficial.",
      ...
      "5. Modificaciones. BorderCheck AI podrá actualizar estos términos; los cambios sustanciales se notificarán a través de la plataforma.",
    ],
  },
  habeas_data: {
    titulo: "Política de Tratamiento de Datos Personales (Habeas Data — Ley 1581 de 2012)",
    cuerpo: [
      "1. Responsable del tratamiento. BorderCheck AI actúa como responsable del tratamiento de los datos personales suministrados por el usuario, incluyendo datos de identificación (nombre, documento de identidad), contacto y datos relativos a sus envíos.",

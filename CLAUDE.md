...
- `Navbar.tsx`: el botón "+ Nueva consulta" tenía el outline azul por defecto del navegador al enfocarse; ahora usa el mismo patrón que `ui/Button` (`focus-visible:ring-cian`, sin outline nativo).

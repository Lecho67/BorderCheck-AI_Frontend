...
- Tests: `usePagination.test.ts`, `Pagination.test.tsx`, ampliados `AgentKycPanel.test.tsx`, `AgentDocumentsPanel.test.tsx`, `AgentPanel.test.tsx` (todos con un caso "pagina cuando hay más de 8") y nuevo `GestorPanel.test.tsx`. **142 tests en 28 archivos.**
